...
def search_edge_metadata_segmentgraph(gene, coord, edge_idxs=None, edge_counts=None):
    ...
    coord: np.array. Sorted coordinates of 4 positions in ascending order
    edge_idxs: np.array. Contains the edge index values for the current gene
    edge_counts: np.array. Contains the edge count values for the current gene
